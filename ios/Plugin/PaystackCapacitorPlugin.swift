 ...
 */
@objc(PaystackCapacitorPlugin)
public class PaystackCapacitorPlugin: CAPPlugin {
    ...
    private let implementation = PaystackCapacitor()
    ...
    @objc func setChargeEmail(_ call: CAPPluginCall) {
      ...
      @objc func setChargeAmount(_ call: CAPPluginCall) {
       ...
       @objc func setReference(_ call: CAPPluginCall) {
          self.reference = call.getString("reference", "")
          call.success()
      }
      ...
      @objc func chargeCard(_ call: CAPPluginCall) {
          ...
          self.charge.reference = self.reference
